...
export default function SimitUploadFirst({ slug }: { slug: string }) {
  ...
  return <div className="mt-6">
    ...
    <div className="rounded-2xl border border-blue-100 bg-blue-50 p-6">
      <div className="rounded-xl border border-blue-200 bg-white p-4 text-sm text-slate-700"><strong>¿Qué necesitas?</strong><p className="mt-1">Ten a la mano el Estado de Cuenta oficial descargado desde SIMIT. El sistema utilizará únicamente la información contenida en ese documento.</p></div>
