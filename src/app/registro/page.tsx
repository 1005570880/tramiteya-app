      ...
      <div className="max-w-md w-full bg-white p-6 rounded-lg shadow">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-end">
            <button className="bg-blue-600 text-white px-4 py-2 rounded">{loading ? 'Registrando...' : 'Registrarse'}</button>
          </div>
        </form>
        <div className="mt-4 text-sm text-slate-500">¿Ya tienes cuenta? <Link href="/login" className="text-blue-600">Entrar</Link></div>
      </div>
    </main>
  );
}
